...
4. From **Select one Azure AI Agent from the list below**, the table lists the available agents with their **Name**, **Model**, and **Agent Id**. Tick the checkbox next to the agent you want to use (e.g. `CodeOptimizer_GPT5`, running `gpt-5-chat`).
